#import "VFNewSubscription.h"

@implementation VFNewSubscription
...
- (void)newSubscription {
    ...
    [manager POST:@"https://apidynamic.vfinance.cn/2/subscription" parameters:params progress:nil success:^(NSURLSessionDataTask * _Nonnull task, id  _Nullable responseObject) {
        NSMutableDictionary *response = [NSMutableDictionary dictionaryWithDictionary:(NSDictionary *)responseObject];
        response[@"type"] = @(VFSubTypeNewSubscription);
