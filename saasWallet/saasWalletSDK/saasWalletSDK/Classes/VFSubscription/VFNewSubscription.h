...
@interface VFNewSubscription : NSObject
/**
...
/**
 *  短信验证码id,使用[VFSubscription smsReq:(phone)]获得; 必填
 */
@property (nonatomic, retain) NSString *sms_id;
/**
 *  短信验证码,使用[VFSubscription smsReq:(phone)]获得; 必填
 */
...
/**
 *  用户银行卡银行名称，通过[VFSubscription subscriptionBanks];获得支持的银行
 */
