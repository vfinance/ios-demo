...
#import "VFNetworking.h"
#import "VFPayConstant.h"
#import "VFPayCache.h"
#import "VFPayObjects.h"

@interface VFPayUtil : NSObject

/** @name util functions*/

/*!
 A wrapper for VFHTTPSessionManager.
 */
 ...
 *
 *  @param string The date string with format defined in kVFDateFormat.
 *
 *  @return NSDate object converted to.
 */
 ...
 *  @param date NSDate object to be converted.
 *
 *  @return The date string with format defined in kVFDateFormat.
 */
...
FOUNDATION_EXPORT void VFPayLog(NSString *format,...) NS_FORMAT_FUNCTION(1,2) ;
